  ...
  return {
    steps: [
      ...
      },
      {
        ...
        description: 'Supplementary check — not required for approval. When available, entity should be Active / Good Standing in its domicile-state Secretary of State registry; dissolved, delinquent, or inactive status warrants an exception and senior review.',
        policyRef: 'Section 11',
        required: false,
        completed: false,
        notes: '',
